...
renv::install(remotes::install_github("bluegreen-labs/ecmwfr"))
...
my_api <- "elenascholz@hotmail.de" # PLEASE INSERT YOUR EMAIL
my_key <- "be3be900-5fe1-459e-9569-d62eb90048af" # PLEASE INSERT YOUR API KEY
...
europe_wind <- terra::rast(
  "C:/Users/elena/Documents/RProjects/perspectivechange/data/europe-wind.nc"
)
...
europe_wind_stream <- europe_wind_stream |>
  dplyr::mutate(
